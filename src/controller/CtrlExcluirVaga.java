...
public class CtrlExcluirVaga implements ICtrlCasoDeUso {
	//
	// ATRIBUTOS
	//
	public enum Status {
	 ...
	 */
	private UIExcluirVaga uiExcluirVaga;
	...
	/**
	 * Referência para o objeto Vaga
	 */
	private VagaDAO dao2 = new VagaDAO();
	//
	// MÉTODOS
	//
	 ...
	 */
	public CtrlExcluirVaga(CtrlManterVagas ctrl, Vaga d) throws ControleException, DadosException {
	...
	public void iniciar() throws ControleException, DadosException {
		...
		this.uiExcluirVaga = (UIExcluirVaga)ViewerManager.obterViewer(this, UIExcluirVaga.class);
		
		// Solicito à interface que carregue os objetos
		this.uiExcluirVaga.exibirExcluir();
	}
